...
#
# zynq_system2.tcl: Tcl script for re-creating project 'zynq_system2'
#
# Generated by Vivado on Wed Jan 08 11:57:47 -03 2020
...
#
# 1. This project restoration tcl script (zynq_system2.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/blroot/zynq_system2/zynq_system2.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#    "/home/blroot/zynq_system2/zynq_system2.srcs/constrs_1/new/led_constraints.xdc"
#
...
set _xil_proj_name_ "zynq_system2"
...
set script_file "zynq_system2.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../zynq_system2"]"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../ZynqBook/ip_repo"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/../zynq_system2/zynq_system2.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]\
]
...
set file "[file normalize "$origin_dir/../zynq_system2/zynq_system2.srcs/constrs_1/new/led_constraints.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/led_constraints.xdc"
...
set_property -name "target_constrs_file" -value "[get_files *new/led_constraints.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/led_constraints.xdc]" -objects $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  user.org:user:led_controller:1.0\
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins led_controller_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_49M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_49M_peripheral_aresetn [get_bd_pins led_controller_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_49M/peripheral_aresetn]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.491342",
   "Default View_TopLeft":"0,-313",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0.21  2019-05-29 bk=1.5064 VDI=41 GEI=36 GUI=JA:9.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1220 -y -70 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1220 -y -50 -defaultsOSRD
preplace portBus LEDs_out_0 -pg 1 -lvl 4 -x 1220 -y 30 -defaultsOSRD
preplace inst led_controller_0 -pg 1 -lvl 2 -x 660 -y 30 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 220 -y 0 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -x 1040 -y 150 -defaultsOSRD
preplace inst rst_ps7_0_49M -pg 1 -lvl 2 -x 660 -y -150 -defaultsOSRD
preplace netloc led_controller_0_LEDs_out 1 2 2 N 30 N
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 -100 430 130 850
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 440 -170n
preplace netloc rst_ps7_0_49M_peripheral_aresetn 1 1 2 480 140 860
preplace netloc processing_system7_0_DDR 1 1 3 460J 110 840J -60 1190
preplace netloc processing_system7_0_FIXED_IO 1 1 3 450J -50 NJ -50 N
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 420J 120 870
preplace netloc ps7_0_axi_periph_M00_AXI 1 1 3 470 270 NJ 270 1190
levelinfo -pg 1 0 220 660 1040 1220
pagesize -pg 1 -db -bbox -sgen 0 -250 1390 290
"
}
